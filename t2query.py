...
def main():
    st.title("แปลผลค่า Lab")
    query_text = st.text_input("กรุณาพิมพ์คำถาม/ข้อกังวลของท่าน")
    ...
    if query_text:
        ...
        # Prepare the DB.
        openai_api_key = "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"  # Replace with your actual OpenAI API key
